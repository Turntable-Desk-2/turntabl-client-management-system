...
public class ClientRegisterTest{
    ...
    Client client6 = new Client(006, "James Barsely", "London", "+233553454472", "james96@gmail.com", ClientLevel.PREMIUM);
...
// Test for getting client by level
    ...
    @Test
    public void getClientById_IdEqualsClientsId(){
        assertEquals(Arrays.asList(client4), register.getClientsById(004));
    }
    @Test
    public void getClientById_IdNotEqualsClientsId(){
